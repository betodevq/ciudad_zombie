...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_vertical.png', 300, 380, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 300, 410, 30, 30, 1),

    new Obstaculo('imagenes/bache.png', 400, 480, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 460, 120, 30, 30, 1),

    new Obstaculo('imagenes/auto_verde_abajo.png', 850, 120, 15, 30, 1),
    new Obstaculo('imagenes/auto_verde_derecha.png', 760, 500, 30, 15, 1),
  ...
  enemigos: [
    new ZombieCaminante('imagenes/zombie1.png', 200, 200, 10, 10, 1, {
      desdeX: 0,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577
    }),
    new ZombieCaminante('imagenes/zombie2.png', 300, 300, 10, 10, 1, {
      desdeX: 0,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577
    }),
    new ZombieCaminante('imagenes/zombie3.png', 400, 400, 10, 10, 1, {
      desdeX: 0,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577
    }),
    new ZombieCaminante('imagenes/zombie4.png', 500, 500, 10, 10, 2, {
      desdeX: 0,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577
    }),
    new ZombieCaminante('imagenes/zombie3.png', 600, 600, 10, 10, 2, {
      desdeX: 0,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577
    ...
    new ZombieConductor('imagenes/tren_horizontal.png', 400, 324, 90, 30, 8, {
      desdeX: 0,
      hastaX: 861,
      desdeY: 0,
      hastaY: 577
...
Juego.dibujar = function () {
  ...
  for (let i = 0; i < 16; i++) {
    if (!(i % 2)) {
      Dibujante.dibujarRectangulo('white', boxX, boxY, 8, 8);
      Dibujante.dibujarRectangulo('black', boxX, boxY + 8, 8, 8);
    } else {
      Dibujante.dibujarRectangulo('black', boxX, boxY, 8, 8);
      Dibujante.dibujarRectangulo('white', boxX, boxY + 8, 8, 8);
    }
    boxX += 8;
  }
};
